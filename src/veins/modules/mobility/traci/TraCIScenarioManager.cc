...
void TraCIScenarioManager::initialize(int stage) {
    ...
    c11 = new Coord(0.0, 1000.0, 0.0);
    c12 = new Coord(2500.0, 1000.0, 0.0);
    annotations->scheduleErase(1, annotations->drawLine(*c11, *c12, "red"));
    c13 = new Coord(0.0, 1750.0, 0.0);
    c14 = new Coord(2500.0, 1750.0, 0.0);
    annotations->scheduleErase(1, annotations->drawLine(*c13, *c14, "red"));
    c21 = new Coord(800.0, 0.0, 0.0);
    c22 = new Coord(800.0, 2500.0, 0.0);
    annotations->scheduleErase(1, annotations->drawLine(*c21, *c22, "red"));
    c23 = new Coord(1750.0, 0.0, 0.0);
    c24 = new Coord(1750.0, 2500.0, 0.0);
    annotations->scheduleErase(1, annotations->drawLine(*c23, *c24, "red"));
